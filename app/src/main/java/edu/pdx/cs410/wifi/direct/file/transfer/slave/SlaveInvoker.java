...
//    }
    ...
    static public void downLoad(DownloadTask task, TcpConnector conn, ThreadStatistics stat) throws Exception {
        /* Initialize storage directory */
        String recvPath;
        String recvFileName;
        recvPath = Environment.getExternalStorageDirectory().getAbsolutePath();
        ...
        long bw = SlaveOperation.httpDownload(task, tempFile, conn.backendService, stat);
