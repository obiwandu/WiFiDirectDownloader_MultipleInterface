...
public class ClientService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        fileToRecv = (File) intent.getExtras().get("fileToRecv");
        ...
        if(!wifiInfo.isGroupOwner)
        {
            ...
            try {
                ...
                fis.close();
                bis.close();
                signalActivity("File Transfer Complete, sent file: " + fileToSend.getName() + ". Ready to receive file back.");

                os.close();
                clientSocket.close();

                //receive the part handled by slave
                ServerSocket serverSocket = new ServerSocket(port);
                clientSocket = serverSocket.accept();
                is = clientSocket.getInputStream();
                FileOutputStream fos = new FileOutputStream(fileToRecv);
                ...
                signalActivity("File receiving complete!");
            } catch (IOException e) {
